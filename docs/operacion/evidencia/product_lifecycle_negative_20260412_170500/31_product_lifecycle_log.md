...
- Generated at (UTC): `2026-04-12T21:53:55.324958+00:00`
...
- [RETAIL_FUEL] -> Validar generación automática de borradores contables -> delta_total>=2 y cobertura mínima por pares ['BILLING.DocumentIssuedImpossible', 'INVENTORY.InventoryMovementPostedImpossible'] -> FAIL | actual: delta_total=0 (before=0, after=0) delta_by_pair={"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}
  - detail: {"schema_version": 1, "required_pairs": [{"pair": "BILLING.DocumentIssuedImpossible", "source_module": "BILLING", "event_type": "DocumentIssuedImpossible", "min_delta": 1}, {"pair": "INVENTORY.InventoryMovementPostedImpossible", "source_module": "INVENTORY", "event_type": "InventoryMovementPostedImpossible", "min_delta": 1}], "min_total_delta": 2, "timing": {"attempts": 3, "elapsed_seconds": 6.97, "max_wait_seconds": 6.0, "poll_interval_seconds": 1.0}, "before": {"total": 0, "by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}}, "after": {"total": 0, "by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}}, "evaluation": {"passed": false, "before_total": 0, "after_total": 0, "total_delta": 0, "delta_by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}, "coverage": [{"pair": "BILLING.DocumentIssuedImpossible", "min_delta": 1, "before": 0, "after": 0, "delta": 0, "passed": false}, {"pair": "INVENTORY.InventoryMovementPostedImpossible", "min_delta": 1, "before": 0, "after": 0, "delta": 0, "passed": false}], "missing_pairs": ["BILLING.DocumentIssuedImpossible", "INVENTORY.InventoryMovementPostedImpossible"]}}

## Error

- `Paso de validación falló: retail_fuel/accounting.auto_draft_from_cash_movement actual=delta_total=0 (before=0, after=0) delta_by_pair={"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0} detail={"schema_version": 1, "required_pairs": [{"pair": "BILLING.DocumentIssuedImpossible", "source_module": "BILLING", "event_type": "DocumentIssuedImpossible", "min_delta": 1}, {"pair": "INVENTORY.InventoryMovementPostedImpossible", "source_module": "INVENTORY", "event_type": "InventoryMovementPostedImpossible", "min_delta": 1}], "min_total_delta": 2, "timing": {"attempts": 3, "elapsed_seconds": 6.97, "max_wait_seconds": 6.0, "poll_interval_seconds": 1.0}, "before": {"total": 0, "by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}}, "after": {"total": 0, "by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}}, "evaluation": {"passed": false, "before_total": 0, "after_total": 0, "total_delta": 0, "delta_by_pair": {"BILLING.DocumentIssuedImpossible": 0, "INVENTORY.InventoryMovementPostedImpossible": 0}, "coverage": [{"pair": "BILLING.DocumentIssuedImpossible", "min_delta": 1, "before": 0, "after": 0, "delta": 0, "passed": false}, {"pair": "INVENTORY.InventoryMovementPostedImpossible", "min_delta": 1, "before": 0, "after": 0, "delta": 0, "passed": false}], "missing_pairs": ["BILLING.DocumentIssuedImpossible", "INVENTORY.InventoryMovementPostedImpossible"]}}`
