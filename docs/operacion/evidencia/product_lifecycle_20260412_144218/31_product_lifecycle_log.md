...
- Generated at (UTC): `2026-04-12T20:44:31.561971+00:00`
...
- [ACCOUNTING] -> Validar huérfanos mínimos obligatorios -> total=0 -> FAIL | actual: total=1
  - detail: {"pos_ticket_closed_missing_sale_or_payment": 0, "fuel_sale_without_dispense": 0, "journal_entry_without_lines": 1, "intercompany_or_consolidation_inconsistency": 0, "closed_intercompany_with_difference": 0, "blocked_consolidation_runs": 0, "total": 1}

## Error

- `Paso de validación falló: accounting/integrity.orphan_checks actual=total=1 detail={"pos_ticket_closed_missing_sale_or_payment": 0, "fuel_sale_without_dispense": 0, "journal_entry_without_lines": 1, "intercompany_or_consolidation_inconsistency": 0, "closed_intercompany_with_difference": 0, "blocked_consolidation_runs": 0, "total": 1}`
