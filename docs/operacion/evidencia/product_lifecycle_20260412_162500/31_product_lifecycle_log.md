...
- Generated at (UTC): `2026-04-12T21:44:25.474110+00:00`
...
- [RETAIL_FUEL] -> Validar generación automática de borradores contables -> delta_total>=2 y cobertura mínima por pares ['BILLING.DocumentIssued', 'INVENTORY.InventoryMovementPosted'] -> PASS | actual: delta_total=21 (before=0, after=21) delta_by_pair={"BILLING.DocumentIssued": 10, "INVENTORY.InventoryMovementPosted": 11}
  - detail: {"schema_version": 1, "required_pairs": [{"pair": "BILLING.DocumentIssued", "source_module": "BILLING", "event_type": "DocumentIssued", "min_delta": 1}, {"pair": "INVENTORY.InventoryMovementPosted", "source_module": "INVENTORY", "event_type": "InventoryMovementPosted", "min_delta": 1}], "min_total_delta": 2, "timing": {"attempts": 1, "elapsed_seconds": 1.35, "max_wait_seconds": 20.0, "poll_interval_seconds": 2.0}, "before": {"total": 0, "by_pair": {"BILLING.DocumentIssued": 0, "INVENTORY.InventoryMovementPosted": 0}}, "after": {"total": 21, "by_pair": {"BILLING.DocumentIssued": 10, "INVENTORY.InventoryMovementPosted": 11}}, "evaluation": {"passed": true, "before_total": 0, "after_total": 21, "total_delta": 21, "delta_by_pair": {"BILLING.DocumentIssued": 10, "INVENTORY.InventoryMovementPosted": 11}, "coverage": [{"pair": "BILLING.DocumentIssued", "min_delta": 1, "before": 0, "after": 10, "delta": 10, "passed": true}, {"pair": "INVENTORY.InventoryMovementPosted", "min_delta": 1, "before": 0, "after": 11, "delta": 11, "passed": true}], "missing_pairs": []}}
