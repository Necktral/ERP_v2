...
- Generated at (UTC): `2026-04-12T20:40:14.656071+00:00`
...
- [RETAIL_FUEL] -> Validar generación automática de borradores contables -> delta_drafts > 0 -> FAIL | actual: delta_drafts=0 (before=0, after=0)

## Error

- `Paso de validación falló: retail_fuel/accounting.auto_draft_from_cash_movement actual=delta_drafts=0 (before=0, after=0) detail=`
