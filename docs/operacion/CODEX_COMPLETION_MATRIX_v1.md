...
| Sync | `modulos.sync_engine` (canónico), `modulos.sync` (legacy/hmac) | cerrado | cerrado | cerrado | cerrado | cerrado | cerrado | alta | `backend/src/config/urls.py`; `frontend/src/pages/SyncEnrollmentPage.vue`; `qa/reports/sync_pos_contract_guard.txt`; PR #68; commit `8fa283c3`; merge `311cf66e`; `docs/operacion/HANDOFF_SYNC_DEVICE_BRANCH_SCOPE_P0_20260504.md` | Mantener baseline; P0 branch-scope cerrado en PR #68. Siguiente: documentar P1 Sync audit/auth edge cases y plan de deprecación sync-hmac. |
