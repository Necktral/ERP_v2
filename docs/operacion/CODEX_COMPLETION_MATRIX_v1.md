...
| `modulos.sync` (`/api/sync-hmac/*`) | retirado | cerrado | cerrado | cerrado | cerrado | cerrado | cerrado | baja | sunset `2026-03-31`; `/api/sync-hmac/*` desmontado | Retirado después del sunset; `sync_engine` queda como canal canónico. |
| `modulos.sync_engine` (`/api/sync/*`, `/api/v1/sync/*`) | `backend/src/apps/modulos/sync_engine` | cerrado | cerrado | cerrado | cerrado | cerrado | cerrado | alta | `backend/src/apps/modulos/sync_engine/urls.py`; `backend/src/tests/test_sync_v2_contract.py`; `frontend/src/pages/SyncEnrollmentPage.vue`; `frontend/src/pages/SyncDevicesPage.vue`; PR #68; commit `8fa283c3`; merge `311cf66e`; `docs/operacion/HANDOFF_SYNC_DEVICE_BRANCH_SCOPE_P0_20260504.md` | Mantener baseline; P0 branch-scope cerrado en PR #68. |
...
| Sync | `modulos.sync_engine` (canónico) | cerrado | cerrado | cerrado | cerrado | cerrado | cerrado | alta | `backend/src/config/urls.py`; `frontend/src/pages/SyncEnrollmentPage.vue`; `qa/reports/sync_pos_contract_guard.txt`; PR #68; commit `8fa283c3`; merge `311cf66e`; `docs/operacion/HANDOFF_SYNC_DEVICE_BRANCH_SCOPE_P0_20260504.md` | Mantener baseline; P0 branch-scope cerrado en PR #68; legacy HMAC retirado. |
