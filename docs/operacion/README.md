...
- [Acta de certificación móvil HTTPS (2026-04-14)](ACTA_CERTIFICACION_MOVIL_HTTPS_20260414.md)
...
- 2026-04-14: Se agrega acta versionada `ACTA_CERTIFICACION_MOVIL_HTTPS_20260414.md`, se fija comando canónico `make qa-auth-mobile-cookie-tests` para pruebas Django en backend container y se mantiene estado de certificación operativa pendiente hasta evidencia móvil real 7/7 PASS.
