...
def resolve_effective_permissions(*, user, company, branch) -> set[str]:
...
def ensure_permissions(*, user, company, branch, required_permissions: Iterable[str]) -> None:
    effective = resolve_effective_permissions(user=user, company=company, branch=branch)
